package com.dl.mediapicker.adapter;
...
public class PopupDirectoryListAdapter extends BaseAdapter {
    ...
    private class ViewHolder {
        ...
        public void bindData(PhotoDirectory directory) {
            ...
            Drawable drawable = tintDrawable(ivCover.getContext().getResources().getDrawable(R.drawable.ic_check_dir), ColorStateList.valueOf(Color.parseColor("#FF45C01A")));
